 ...
 */
@Uninterruptible
public final class GarbageFirstTraceLocal extends GenMatureTraceLocal { // only trace for mark stage for now

  /**
   * @param global the global trace class to use
   * @param plan the state of the generational collector
   */
  public GarbageFirstTraceLocal(Trace global, GenCollector plan) {
    super(global, plan);
  }
